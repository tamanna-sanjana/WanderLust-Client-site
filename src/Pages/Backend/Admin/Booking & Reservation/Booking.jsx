...
const Booking = () => {
  ...
  const fetchBookings = async () => {
    ...
    try {
      const res = await axios.get("https://wander-lust-server-site.vercel.app/all/booking");
                      ...
                      {booking.status !== 2 && (
                        <>
                          {booking.status === 0 && (
                            <button
                              onClick={() =>
                                handleStatusUpdate(booking._id || booking.id, 1)
                              }
                          ...
                          {booking.status === 1 && (
                            <button
                              onClick={() =>
                                handleStatusUpdate(booking._id || booking.id, 2)
                              }
