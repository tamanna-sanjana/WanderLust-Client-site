  ...
  return (
    ...
    >
      <nav className="navbar px-4 md:px-10 py-3 text-white">
        ...
        {/* Navbar End - Book Button */}
        <div className="navbar-end flex justify-end">
          {/* ✅ Now shows on all screens */}
          <a className="btn bg-blue-950 rounded-2xl text-xl px-5 py-2 border border-blue-900 hover:bg-cyan-900 transition">
            Book Now
          </a>
        </div>
      </nav>
